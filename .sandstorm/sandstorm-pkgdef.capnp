...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "mcd2v7vd6ecfn0j9v0tqqf0jyw138up5r6jsesaneg1d5gp8ndeh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "TiddlyWiki App"),

    appVersion = 1,  # Increment this for every release.

    appMarketingVersion = (defaultText = "0.1.0+v1"),
    ...
    metadata = (
      ...
      author = (
        ...
        contactEmail = "thierrypasquier@gmail.com",
        ...
        upstreamAuthor = "Jeremy Ruston, UnaMesa",
      ...
      shortDescription = (defaultText = "non-linear wiki"),
